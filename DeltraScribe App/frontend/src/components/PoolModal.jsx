...
import { X, HandMetal, AlertCircle, CheckCircle2 } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm p-4 animate-fade-in">
            <div className="bg-white rounded-[40px] w-full max-w-md shadow-2xl overflow-hidden transform transition-all border border-gray-100 p-8 space-y-6">
                <div className="flex justify-between items-center">
                    <div className="p-4 bg-deltascribe-navy/10 rounded-3xl text-deltascribe-navy">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    >
                        {isSubmitting ? <Logo className="w-5 h-5 animate-spin" color="currentColor" /> : <HandMetal className="w-5 h-5" />}
