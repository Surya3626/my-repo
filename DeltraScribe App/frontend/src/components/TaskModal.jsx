      ...
      <div className="bg-white rounded-[32px] w-full max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl relative z-10 animate-scale-in flex flex-col">
        ...
        <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
          <div className="flex items-center space-x-3">
             <div className="p-2 rounded-xl text-white bg-deltascribe-navy">
             ...
             <div>
                ...
                <div className="flex items-center space-x-2">
                    <span className="text-[10px] font-bold text-deltascribe-emerald uppercase tracking-widest">{formData.jtrackId || 'NEW-TASK'}</span>
               ...
               {auditLogs.length === 0 ? (
                 ...
                 <div key={log.id} className="flex items-start space-x-4 p-4 rounded-2xl border border-gray-50 hover:bg-gray-50/50 transition-all">
                    ...
                    <div className="flex-1">
                        ...
                        {log.remarks && (
                            <div className="mt-2 p-3 bg-gray-50 rounded-xl border-l-4 border-deltascribe-navy/20">
