                    ...
                    <div className="flex bg-gray-100 p-1.5 rounded-2xl border border-gray-200 shadow-sm self-start">
                        <button 
                            ...
                            className={`px-6 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all ${
                                filterBucket === 'MY_BUGS' ? 'bg-white text-deltascribe-emerald shadow-md' : 'text-gray-400 hover:text-gray-600'
                            }`}
                        >
                            My Raised Bugs
                        </button>
                        <button 
                            ...
                            className={`px-6 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all ${
                                filterBucket === 'ALL' ? 'bg-white text-deltascribe-emerald shadow-md' : 'text-gray-400 hover:text-gray-600'
                            }`}
                        >
                            All Pending
                        </button>
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-gray-50 border border-gray-100 rounded-2xl py-3 px-4 min-h-[120px] font-medium text-gray-800 outline-none focus:bg-white focus:border-deltascribe-emerald transition-all"
                                />
                            </div>
