...
import { Search, Tag, BarChart2, CheckCircle, XCircle } from 'lucide-react';
        ...
        <div className="space-y-6 animate-fade-in">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                   ...
                   <p className="text-emerald-200 font-medium">Verify code quality and adherence to standards.</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredTasks.length === 0 ? (
                    ...
                    <div 
                        key={task.id} 
                        className="glass-morphism p-6 hover:shadow-2xl hover:-translate-y-1 transition-all group cursor-pointer border-l-4 border-deltascribe-emerald"
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-white/10">
                            ...
                            <div className="p-2 rounded-xl bg-white/5 text-gray-400 group-hover:bg-deltascribe-emerald group-hover:text-white transition-all">
