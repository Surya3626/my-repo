                    ...
                    >
                        <div>
                            <div className="flex justify-between items-start mb-6">
                                <span className="text-[10px] font-black text-deltascribe-navy uppercase tracking-widest bg-slate-50 px-3 py-1.5 rounded-full border border-slate-100 shadow-sm">
                            ...
                            <h3 className="text-xl font-black text-gray-800 leading-tight mb-4 group-hover:text-deltascribe-emerald transition-colors">
                                {item.title}
                            </h3>
