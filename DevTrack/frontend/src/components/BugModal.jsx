      ...
      <div className="bg-white rounded-[32px] w-full max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl relative z-10 animate-scale-in flex flex-col">
        ...
        <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
          <div className="flex items-center space-x-3">
             <div className="p-2 rounded-xl text-white bg-gradient-to-br from-tata-pink to-pink-600">
             ...
             <div>
                ...
                <div className="flex items-center space-x-2">
                    <span className="text-[10px] font-bold text-tata-pink uppercase tracking-widest">{formData.jtrackId || 'NEW-BUG'}</span>
            ...
            <form onSubmit={handleSave} className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  {!selectedWorkflow ? (
                    ...
                    {(snapshottedSteps.length > 0 ? snapshottedSteps : selectedWorkflow.steps)
                      ...
                      {item && item.status !== 'CLOSED' && item.status !== 'VERIFIED&CLOSED' && (currentUser?.roles?.includes('ROLE_DEVELOPER') || currentUser?.roles?.includes('ROLE_DEVADMIN')) && (
                          <option value="INVALID_BUG_ACTION" className="text-pink-600 font-bold">⛔ Mark as Invalid Bug</option>
                      )}
              ...
              <div className="space-y-2">
                ...
                {showQuickTask && (
                    <div className="bg-pink-50 p-4 rounded-xl border border-pink-100 mb-2 space-y-3 animate-slide-down md:col-span-2">
                        ...
                        <textarea 
                            ...
                            className="w-full bg-white border border-gray-100 rounded-lg py-2 px-3 text-sm font-bold outline-none focus:border-tata-pink resize-none"
                            rows="2"
                        />
                        <div className="flex items-center space-x-2">
                            <select 
                ...
                <select 
                    ...
                    onChange={handleChange} 
                    className="w-full bg-gray-50 border border-gray-100 rounded-2xl py-3 px-4 font-bold text-gray-800 focus:bg-white focus:border-tata-pink"
                >
              ...
              <div className="space-y-2">
                ...
                <select 
                  ...
                  onChange={handleChange} 
                  className="w-full bg-gray-50 border border-gray-100 rounded-2xl py-3 px-4 font-bold text-gray-800 transition-all outline-none focus:bg-white focus:border-tata-pink"
                >
        ...
        <div className="p-6 border-t border-gray-100 bg-gray-50/50 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
             ...
             {!isTerminalState && (
                 <button 
                    onClick={handleSave}
                    className="btn-tata flex items-center space-x-2 py-2.5 px-8 shadow-lg shadow-tata-pink/20"
                 >
