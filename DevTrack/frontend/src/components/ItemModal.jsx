        ...
        <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
          <div className="flex items-center space-x-3">
             <div className={`p-2 rounded-xl text-white bg-gradient-to-br ${
               type === 'task' ? 'from-tata-purple to-indigo-600' : 
               type === 'bug' ? 'from-tata-pink to-pink-600' : 'from-emerald-400 to-teal-500'
             }`}>
             ...
             <div>
                ...
                <div className="flex items-center space-x-2">
                    <span className="text-[10px] font-bold text-tata-pink uppercase tracking-widest">{formData.jtrackId || 'NEW-ITEM'}</span>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className={`w-full bg-gray-50 border border-gray-100 rounded-2xl py-3 px-4 font-medium text-gray-800 transition-all outline-none resize-none ${
                        ...
                        (item && type === 'testcase' && !currentUser?.roles?.some(r => r.includes('ADMIN')) && currentUser?.id !== item.createdBy?.id) ? 'opacity-60 cursor-not-allowed' : 'focus:bg-white focus:border-tata-pink'
                      }`}
