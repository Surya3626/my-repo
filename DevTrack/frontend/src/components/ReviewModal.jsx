  ...
  const modalContent = (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-xl bg-white rounded-[32px] shadow-2xl overflow-hidden animate-zoom-in border border-white/20">
        ...
        <div className="absolute top-0 right-0 w-64 h-64 bg-tata-pink/5 rounded-full -mr-32 -mt-32 blur-3xl pointer-events-none" />
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <div className="flex items-center space-x-2">
                <span className="text-[10px] font-black text-tata-pink uppercase tracking-widest bg-pink-50 px-2 py-0.5 rounded-lg">
        ...
        <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
          ...
          <section className="space-y-4">
            ...
            <textarea
              className="w-full p-6 bg-slate-50 border border-slate-100 rounded-[32px] font-bold text-slate-700 focus:bg-white focus:border-tata-pink focus:ring-4 focus:ring-tata-pink/5 transition-all outline-none min-h-[120px] shadow-inner"
          ...
          {item.status === 'CODE_REVIEW' ? (
            <>
              ...
              <button 
                ...
                className="flex-1 flex items-center justify-center space-x-3 py-3 px-6 bg-tata-gradient text-white rounded-xl font-black text-xs uppercase tracking-widest shadow-xl shadow-tata-pink/20 hover:scale-[1.02] transition-all active:scale-95"
              >
