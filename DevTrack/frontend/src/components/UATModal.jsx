                ...
                <div className="p-8 space-y-6">
                    <div className="flex justify-between items-center">
                        <div>
                            <span className={`text-[10px] font-black uppercase tracking-[0.2em] px-3 py-1 rounded-full border mb-2 inline-block ${
                                type.toUpperCase() === 'SIT' ? 'text-indigo-600 bg-indigo-50 border-indigo-100' : 'text-tata-pink bg-pink-50 border-pink-100'
                            }`}>
                                {phaseLabel}
                            </span>
                    ...
                    <div className="space-y-3">
                        ...
                        <textarea
                            ...
                            className="w-full bg-gray-50 border border-gray-100 rounded-3xl p-5 min-h-[150px] outline-none focus:ring-4 focus:ring-tata-pink focus:ring-opacity-10 focus:border-tata-pink transition-all font-medium text-gray-700"
                        />
                    </div>
