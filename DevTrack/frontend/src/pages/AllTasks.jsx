...
import { Plus, Search, Filter, CheckSquare, Clock, AlertCircle, ChevronRight, Activity, Tag, BarChart2, Download, Zap } from 'lucide-react';
...
const AllTasks = () => {
    ...
    const handleExport = () => {
        ...
        XLSX.writeFile(wb, `DevTrack_Enterprise_Tasks_${new Date().toISOString().split('T')[0]}.xlsx`);
    };
        ...
        <div className="space-y-6 animate-fade-in">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <button 
                        ...
                        className="btn-glass flex items-center space-x-2 py-2.5 px-6 shadow-sm border border-gray-100 font-bold text-gray-700 hover:text-tata-pink transition-all"
                    >
            ...
            <div className="bg-white border border-gray-100 p-6 rounded-[32px] flex flex-col md:flex-row gap-4 shadow-sm">
                ...
                <div className="flex items-center space-x-2">
                    <button className="p-2.5 rounded-xl bg-white border border-gray-100 text-gray-400 hover:text-tata-pink transition-all">
