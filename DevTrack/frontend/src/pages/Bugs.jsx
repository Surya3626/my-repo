...
import { 
    Plus, Search, Filter, Bug, AlertCircle, ChevronRight, Activity, 
...
const Bugs = () => {
    ...
    const handleExportToExcel = () => {
        ...
        XLSX.writeFile(wb, `DevTrack_Bugs_Report_${new Date().toISOString().split('T')[0]}.xlsx`);
    };
                ...
                <div className="flex items-center space-x-3">
                    <div className="flex items-center space-x-2 mr-4">
                        <input 
                            ...
                            className="w-4 h-4 rounded border-gray-300 text-tata-pink focus:ring-tata-pink"
                        />
            ...
            <div className="bg-white border border-gray-100 p-6 rounded-[32px] flex flex-col md:flex-row gap-4 shadow-sm">
                <div className="flex-1 relative">
                    ...
                    <input
                        ...
                        className="w-full bg-white bg-opacity-50 border border-gray-100 rounded-2xl py-2.5 pl-11 pr-4 outline-none focus:border-tata-pink focus:ring-4 focus:ring-tata-pink focus:ring-opacity-5 font-medium transition-all"
                    />
                </div>
                <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-2">
                    <div className="relative w-full sm:w-auto">
                        <select 
                            ...
                            className="w-full appearance-none bg-white border border-gray-100 rounded-2xl py-2.5 pl-4 pr-10 outline-none focus:border-tata-pink focus:ring-4 focus:ring-tata-pink focus:ring-opacity-5 font-bold text-gray-600 transition-all cursor-pointer"
                        >
                    ...
                    <div className="relative w-full sm:w-auto">
                        <select 
                            ...
                            className="w-full appearance-none bg-white border border-gray-100 rounded-2xl py-2.5 pl-4 pr-10 outline-none focus:border-tata-purple focus:ring-4 focus:ring-tata-purple focus:ring-opacity-5 font-bold text-gray-600 transition-all cursor-pointer"
                        >
                    ...
                    return (
                        <div key={task.id} className="bg-white rounded-[32px] border border-gray-100 overflow-hidden shadow-sm transition-all hover:shadow-md">
                            <div 
                                ...
                                className={`p-6 flex items-center justify-between cursor-pointer transition-colors ${isExpanded ? 'bg-pink-50/30' : 'hover:bg-gray-50'}`}
                            >
                                <div className="flex items-center space-x-4">
                                    <div className={`p-3 rounded-2xl ${isExpanded ? 'bg-tata-pink text-white' : 'bg-gray-100 text-gray-400'}`}>
                                        <Layout className="w-5 h-5" />
                                    </div>
                                    <div>
                                        <div className="flex items-center space-x-2">
                                            <span className="text-[10px] font-black text-tata-pink uppercase tracking-widest">{task.jtrackId}</span>
                                            ...
                                            {taskBugs.map(bug => (
                                                <tr key={bug.id} className="group hover:bg-gray-50/50 transition-colors">
                                                    <td className="py-4 pl-4">
                                                        <span className="text-xs font-black text-tata-pink">{bug.jtrackId || `B-${bug.id}`}</span>
                                                    </td>
                                                    <td className="py-4">
                                                    ...
                                                    <td className="py-4 text-right pr-4">
                                                        <button 
                                                            ...
                                                            className="p-2 rounded-xl bg-gray-50 text-gray-400 hover:bg-tata-pink hover:text-white transition-all transform hover:scale-110"
                                                        >
