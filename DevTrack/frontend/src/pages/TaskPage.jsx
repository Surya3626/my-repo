...
import { Search, Filter, Activity, Tag, BarChart2 } from 'lucide-react';
...
const TaskPage = () => {
    ...
    if (isLoading) return <div className="p-8"><Activity className="animate-spin text-tata-pink" /></div>;
            ...
            <div className="glass-morphism p-6 flex flex-col md:flex-row gap-4">
                <div className="flex-1 relative">
                    ...
                    <input
                        ...
                        className="w-full bg-white/10 border border-white/20 rounded-2xl py-2.5 pl-11 pr-4 outline-none focus:border-tata-pink text-white font-medium transition-all"
                    />
                </div>
                ...
                {filteredTasks.length === 0 ? (
                    ...
                    >
                        <div className="flex items-start justify-between mb-4">
                            <span className="text-[10px] font-black text-tata-pink uppercase tracking-widest bg-pink-50/10 px-3 py-1 rounded-full border border-tata-pink/20">
                                {task.jtrackId}
                            </span>
                        ...
                        <h3 className="text-lg font-black text-white mb-2 line-clamp-1 group-hover:text-tata-pink transition-colors">
                            {task.title}
                        </h3>
                        ...
                        <div className="flex items-center justify-between pt-6 border-t border-white/10">
                            ...
                            <div className="p-2 rounded-xl bg-white/5 text-gray-400 group-hover:bg-tata-pink group-hover:text-white transition-all transform group-hover:rotate-12">
