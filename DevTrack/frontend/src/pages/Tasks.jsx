...
import { Plus, Search, Filter, CheckSquare, Clock, AlertCircle, ChevronRight, Activity, Tag, BarChart2 } from 'lucide-react';
                ...
                {filteredTasks.length === 0 ? (
                    ...
                    >
                        <div className="flex items-start justify-between mb-4">
                            <span className="text-[10px] font-black text-tata-pink uppercase tracking-widest bg-pink-50 px-3 py-1 rounded-full">
                        ...
                        <h3 className="text-lg font-black text-gray-800 mb-2 line-clamp-1 group-hover:text-tata-pink transition-colors">
                            {task.title}
                        </h3>
                        ...
                        <div className="flex items-center justify-between pt-6 border-t border-gray-50">
                            <div className="flex items-center space-x-4">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-xs font-black text-tata-purple uppercase">{task.type?.name}</span>
                                </div>
                            </div>
                            <div className="p-2 rounded-xl bg-gray-50 text-gray-400 group-hover:bg-tata-pink group-hover:text-white transition-all transform group-hover:rotate-12">
