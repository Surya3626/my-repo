...
import { Search, Activity, Tag, BarChart2, ShieldCheck, ShieldAlert } from 'lucide-react';
...
const TestingPage = () => {
    ...
    if (isLoading) return <div className="p-8"><Activity className="animate-spin text-green-400" /></div>;
        ...
        <div className="space-y-6 animate-fade-in">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                   ...
                   <p className="text-green-200 font-medium">Validate features and ensure bug-free delivery.</p>
                </div>
            </div>
            ...
            <div className="glass-morphism p-6 flex flex-col md:flex-row gap-4">
                <div className="flex-1 relative">
                    ...
                    <input
                        ...
                        className="w-full bg-white/10 border border-white/20 rounded-2xl py-2.5 pl-11 pr-4 outline-none focus:border-green-400 text-white font-medium transition-all"
                    />
                </div>
