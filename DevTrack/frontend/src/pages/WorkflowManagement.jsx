    ...
    <div className="p-8 space-y-8 animate-fade-in max-w-7xl mx-auto">
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className="bg-indigo-600 text-white px-6 py-3 rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl shadow-indigo-200 hover:scale-105 active:scale-95 transition-all flex items-center space-x-2"
        >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-[40px] w-full max-w-md p-10 relative z-10 shadow-2xl animate-scale-in">
            ...
            <form onSubmit={handleCreateWorkflow} className="space-y-6">
              ...
              <button 
                type="submit"
                className="w-full bg-indigo-600 text-white rounded-2xl py-4 font-black shadow-xl shadow-indigo-100 hover:bg-indigo-700 transition-all"
              >
                INITIALIZE WORKFLOW
              </button>
            </form>
